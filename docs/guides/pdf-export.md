...
![Documentation build pipeline](../assets/diagrams/build-pipeline.svg)

This diagram is pre-rendered by `npm run docs:diagrams` to `../assets/diagrams/build-pipeline.svg` for embedding in the PDF; the rendered SVG is generated by the build and is gitignored — see [`../assets/README.md`](../assets/README.md).
