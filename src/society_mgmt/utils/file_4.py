"""mod_4 - society module: name-preserving bindings for mod_4_0..mod_4_1199.

Each original ``mod_4_K`` name is bound at import time to a thin wrapper
...
This module ports the JavaScript source ``src/utils/file_4.js`` (1,200
byte-identical ``mod_4_K`` functions). The original, never-read
...
# Generate the full contiguous set mod_4_0 .. mod_4_1199 by construction,
