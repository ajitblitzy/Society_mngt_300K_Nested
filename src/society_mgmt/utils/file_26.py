"""mod_26 - society module: name-preserving bindings for mod_26_0..mod_26_1199.

Each original ``mod_26_K`` name is bound at import time to a thin wrapper
...
This module ports the JavaScript source ``src/utils/file_26.js`` (1,200
byte-identical ``mod_26_K`` functions). The original, never-read
...
# Generate the full contiguous set mod_26_0 .. mod_26_1199 by construction,
